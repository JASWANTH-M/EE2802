...
\end{enumerate}
\textbf{Solution:} Consider the random variables $X_1, X_2, X_3$, which denotes the first, second and third toss respectively as described in table \ref{tab:1}.
\begin{table}[h]
\centering
\input{tables/table1.tex}
\caption{Random variables $X_1, X_2, X_3$}
\label{tab:1}
\end{table}

The probabilities for the random variables $X_1, X_2, X_3$ is listed in table \ref{tab:2}.
\begin{table}[h]
\centering
...
\end{align}
\begin{align}
&= \frac{\pr{X_1 + X_2 + X_3 = 0}}{\pr{X_1 + X_2 = 0}}\\
&= \frac{1}{2}
\end{align}
...
E &: X_1 + X_2 + X_3 \leq 1\\
F &: X_1 + X_2 + X_3 \geq 1\\
F^{\prime} &: X_1 + X_2 + X_3 = 0 
\end{align}
The required probability is given by,
\begin{align}
&= \frac{\pr{X_1 + X_2 + X_3 = 1}}{1 - \pr{X_1 + X_2 + X_3 = 0}}\\
...
$E^{\prime}$ : all 3 tails, $F^{\prime}$ : zero tails. \\
The events $E^{\prime}, F^{\prime}$ can be described by the RV as
\begin{align}
E^{\prime} &: X_1 + X_2 + X_3 = 3\\
F^{\prime} &: X_1 + X_2 + X_3 = 0 
\end{align}
The required probability is given by,
\begin{align}
&= \frac{1 - \pr{X_1 + X_2 + X_3 = 0 \text{ or }3}}{1 - \pr{X_1 + X_2 + X_3 = 0}}\\
