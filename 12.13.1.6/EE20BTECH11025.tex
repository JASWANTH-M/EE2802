...
\begin{align}
E &: X \leq 1 \label{eq:3}\\
F &: X \geq 1 \label{eq:4}\\
F^{\prime} &: X = 0 
\end{align}
The required probability is given by,
\begin{align}
...
\end{align}
The inequality conditions of $EF$ as in \ref{eq:3}, \ref{eq:4} reduces to the equality condition as in \ref{eq:5}
\begin{align}
&= \frac{\pr{X = 1}}{1 - \pr{X = 0}}  \label{eq:5}\\
