...
&= \frac{1}{2}
\end{align}
\item The set of possible numbers greater than or equal to 3 contains 3,4,5,6
\begin{align}
\pr{X \in \{3,4,5,6\}} &= 1 - \pr{X \in \{1,2\}}\\
&= 1 - \brak{\pr{X = 1} + \pr{X = 2}}\\
&= \frac{2}{3}
\end{align}
\item The set of possible numbers less than or equal to 1 just contains 1
\begin{align}
\pr{X \in \{1\}} &= \pr{X = 1}\\
&= \frac{1}{6}
\end{align}
\item The set of possible numbers more than 6 is a null set
\begin{align}
\pr{X \in \phi} &= 0
\end{align}
\item The set of possible numbers less than 6 contains 1,2,3,4,5
\begin{align}
\pr{X \in \{1,2,3,4,5\}} &= 1 - \pr{X \in \{6\}}\\
&= \frac{5}{6}
\end{align}
\end{enumerate}
\end{enumerate}
