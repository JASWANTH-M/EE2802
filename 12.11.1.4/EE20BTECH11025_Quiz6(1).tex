...
\textbf{Solution:} The points given are,
\begin{align}
\vec{A}\myvec{2\\3\\4}, \, \vec{B}\myvec{-1\\-2\\1}, \,\vec{C}\myvec{5\\8\\7}
\end{align}

To check whether the given points are collinear, we find the rank of the matrix $\myvec{\vec{A} & \vec{B} & \vec{C}}$

\begin{align}
\myvec{2&-1&5\\3&-2&8\\4&1&7}\\
\xleftrightarrow[R_3 \leftarrow R_3 - 2R_1]{R_2 \leftarrow R_2 - \frac{3}{2}R_1}\\
\myvec{2&-1&5\\ \\0&-\dfrac{1}{2}&\dfrac{1}{2}\\ \\0&3&-3}\\
\xleftrightarrow{R_3 \leftarrow R_3 + 6R_2}\\
\myvec{2&-1&5\\\\0&-\dfrac{1}{2}&\dfrac{1}{2}\\\\0&0&0}
\end{align}
