...
\textbf{Solution:} Let there be $n$ blue balls in the jar. Then, out of 24 marbles the jar has $24-n$ green balls. Given that
\begin{align}
\pr{\text{Marble drawn is green}} &= \frac{2}{3}
\end{align}
\begin{align}
\frac{24-n}{24} &= \frac{2}{3}\\
\frac{n}{24} &= \frac{1}{3}\\
n &= 8
\end{align}
\end{enumerate}
