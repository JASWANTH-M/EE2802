...
\begin{align}
a-2x > 0,\,  x > 0\\
\implies 0 < x < \frac{a}{2} \label{eq:0}
\end{align} 
Volume of the box is given by
\begin{align}
V\brak{x} = x(a-2x)^2
\end{align}
We now check the convexity of the function $V\brak{x}$ under the constraints given by \eqref{eq:0}
\begin{align}
...
So the given problem cannot be expressed as a Convex optimization problem.
\end{enumerate}
\end{document}
