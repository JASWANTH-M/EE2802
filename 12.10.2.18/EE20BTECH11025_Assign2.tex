...
\end{figure}
\textbf{Solution:} From the triangle law of vector addition, we get
\begin{align}
\overrightarrow{AB} + \overrightarrow{BC} = \overrightarrow{AC}\\
\Rightarrow \overrightarrow{AB} + \overrightarrow{BC} - \overrightarrow{AC} = \overrightarrow{0} \label{eq:1}
\end{align}
The equation \ref{eq:1} is option B.

We know that
$\overrightarrow{AC} = - \overrightarrow{CA}$

\begin{align}
\Rightarrow \overrightarrow{AB} + \overrightarrow{BC} + \overrightarrow{CA} = \overrightarrow{0} \label{eq:2}
\end{align}

The equation \ref{eq:2} is option A.

We know that
$\overrightarrow{BC} = - \overrightarrow{CB}$
\begin{align}
\Rightarrow \overrightarrow{AB} - \overrightarrow{CB} + \overrightarrow{CA} = \overrightarrow{0} \label{eq:3}
\end{align}
The equation \ref{eq:3} is option D.
